package com.crescenzi.esptoolbox.data.usb.firmware.data.repository

import android.content.Context
import com.crescenzi.esptoolbox.data.core.params.BaudRateFormat
import com.crescenzi.esptoolbox.data.core.params.EspModel
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.EspRepoParams
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.EspRepoParams.CHIP_DETECT_MAGIC_REG_ADDRESS
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.EspRepoParams.ESP_SPI_SET_PARAMS
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.appendArray
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.checksum
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.intToByteArray
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.readRegister
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.sendCommand
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.subArray
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.sync
import com.crescenzi.esptoolbox.data.usb.firmware.data.util.timeoutPerMb
